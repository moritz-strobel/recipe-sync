...
import { LoginComponent } from "./overlay/login/login.component";
import { RegisterComponent } from "./overlay/register/register.component";
import { ForgotPasswordComponent } from "./overlay/forgot-password/forgot-password.component";
